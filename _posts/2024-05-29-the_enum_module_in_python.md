...
Using the enum module in Python can make the code more readable and also help with autocompletion in IDEs (can lessen risk for typos etc.) It's useful for e.g. replacing magic numbers, in if statements etc.
